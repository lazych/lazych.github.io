...
ImColor mainColor = ImColor(181.f, 126.f, 220.f, 255.f); // Used on buttons & items
ImColor secondColor = ImColor(129.f, 66.f, 174.f, 255.f); // Used on buttons when are clicked etc...

ImColor white = ImColor(245.f, 245.f, 220.f, 255.f); // General colors
